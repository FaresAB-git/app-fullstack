export const getProjectByUser = async () => {
    ...
    const response = await fetch(import.meta.env.VITE_API_URI+'/api/project/user/' + userId, {
      method: 'GET',
      headers: {
...
export const createProject = async (title, description) => {
  ...
  const response = await fetch(import.meta.env.VITE_API_URI+'/api/project', {
    method: 'POST',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export const addUserToProject = async (projectId, userId) => {
  ...
  const response = await fetch(import.meta.env.VITE_API_URI+'/api/project/'+ projectId + '/user/' + userId, {
    method: 'POST',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export const getProjectUsers = async (projectId) => {
  ...
  const response = await fetch(import.meta.env.VITE_API_URI+'/api/project/'+ projectId + '/users', {
    method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
